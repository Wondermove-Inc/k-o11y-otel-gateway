...
func (e *clickhouseLogsExporter) addAttrsToTagStatement(
	...
	for attrKey, attrVal := range attrs.StringData {
		...
		// FIX: Call addAttrsToAttributeKeysStatement BEFORE shouldSkipKeys check
		// to ensure keys are always inserted to logs_resource_keys/logs_attribute_keys
		// See: https://github.com/SigNoz/signoz-otel-collector/pull/679
